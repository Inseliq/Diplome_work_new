...
function NewsDetail() {
  const { id } = useParams();
  const { news: item, loading } = useNewsDetail(id);
    ...
    <div className="wrapper news-detail">
      <div className="container">
        <nav className="news-detail__breadcrumb reveal">
          <Link to="/" className="news-detail__crumb">
            Главная
          </Link>

          <span className="news-detail__crumb-sep">/</span>

          <Link to="/news" className="news-detail__crumb">
            Новости
          </Link>

          <span className="news-detail__crumb-sep">/</span>

          <span className="news-detail__crumb news-detail__crumb--active">
            {item.title}
          </span>
        </nav>
          ...
          <article className="news-detail__article reveal">
            <div className="news-detail__hero">
              ...
              <div className="news-detail__hero-meta">
                ...
                <time className="news-detail__date" dateTime={item.dateISO}>
                  {item.date}
                </time>
              </div>
            </div>
            ...
            <div className="news-detail__content markup">
              {item.content
                ...
                : (
                  <p className="markup-p" style={{ color: 'var(--text-dim)' }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="news-detail__related-body">
                        ...
                        <p className="news-detail__related-title">
                          {n.title}
                        </p>

                        <time className="news-detail__related-date">
                          {n.date}
                        </time>
                      </div>
                    </Link>
